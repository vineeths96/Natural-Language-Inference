...
from deep_model.BiLSTM.preprocess import preprocess_testdata
...
def BL_model_test(data):
    ...
    plot_confusion_matrix(confusion_mtx, "BiLSTM", classes=range(3))
